...
| Medan | Nilai |
| --- | --- |
| KOD DAN NAMA PROGRAM | IT-020-4:2013 PENGURUSAN SISTEM KOMPUTER |
| TAHAP | 4 |
| KOD DAN TAJUK UNIT KOMPETENSI | IT-020-4:2013-L4-C01 NETWORK INFRASTRUCTURE DIAGNOSTICS |
| NO. KOD | IT-020-4:2013-L4-C01/KA |
| Muka Surat | 1/1 |
| WARNA KERTAS | MERAH JAMBU (Pink) |

**TAJUK:** PENILAIAN PENGETAHUAN (Knowledge Assessment)

**ARAHAN:** Answer ALL scenarios. Penilaian ini adalah sebahagian daripada Penilaian Akhir CU.
