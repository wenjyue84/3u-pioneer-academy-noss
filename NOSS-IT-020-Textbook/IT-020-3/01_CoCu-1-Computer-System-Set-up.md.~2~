---
title: "CoCu 1: Computer System Set-up (300 hrs)"
date: 2026-02-07
tags:
  - project
  - education
...
| LEVEL | L3 | L3 |
| NO. AND UNIT TITLE OF COMPETENCY | CoCu 1: Computer System Set-up | CoCu 1: Computer System Set-up |
...
| RAM (Random Access Memory) | Temporary storage for running programs and data. Types include DDR4 and DDR5; capacity and speed must be compatible with the motherboard and CPU. Modules are installed in the correct slots (often pairs for dual-channel). Not fully seated or incompatible RAM can cause no POST or random crashes. |
...
| Storage (HDD / SSD / NVMe) | HDD (hard disk drive) is used for bulk storage at lower cost; SSD and NVMe offer much faster boot and application load. Interface (SATA, M.2, PCIe) must match the motherboard. NVMe drives use M.2 or PCIe slots and often require a standoff and screw for mounting. |
