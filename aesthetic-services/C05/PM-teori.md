...
| NO. KOD | S960-002-3:2020-C05/PM(TEORI) |
| Muka Surat | 1/1 |
| WARNA KERTAS | KUNING (Yellow) |

**TAJUK:** PELAN MENGAJAR TEORI / THEORY LESSON PLAN

**TUJUAN:** Sessions 1-6 covering KP(1/6) through KP(6/6) with corresponding KTs. Each session: Persediaan → Penyampaian → Penggunaan → Pengesahan.
...
**Kod / Code:** S960-002-3:2020-C05 | **CU:** C05 — Body Wrap Therapy | **Paper Colour:** YELLOW
**Theory Duration:** 8 hours | **KP:** 6 | **KT:** 6

---

## Instructional Plan
Sessions 1-6 covering KP(1/6) through KP(6/6) with corresponding KTs. Each session: Persediaan → Penyampaian → Penggunaan → Pengesahan.

Topics: Work area hygiene/setup, consultation/contraindications, pre-procedure cleansing, body wrap methods (cold/warm/herbal/mud), post-wrap advice, sterilisation/inventory/waste.