...
**Kaedah (Jay, 2026-09-18):** mula dari perancangan jadual pegawai, kemudian turun langkah demi langkah sampai bahan akhir (Nota/Kertas Penerangan, Soalan, bukti kerja). Setiap langkah di bawah menunjuk kepada **fail dalam format rujukan pegawai** yang boleh dimuat turun terus dari GitHub (`video-film-editing/12-fail-pegawai/`). Urutan ini ikut agenda Bengkel MPC 17–19 Sep 2026 (Topik 4 Matrik → Topik 5 Jadual → Topik 6 Bahan Pembelajaran → Topik 7/8 JSU & Soalan → Bukti & Verifikasi).

> Pautan muat turun: setiap fail di `12-fail-pegawai/` boleh diambil dari GitHub dengan butang **Download raw** — laluan penuh:
> `https://github.com/wenjyue84/3u-pioneer-academy-noss/tree/master/video-film-editing/12-fail-pegawai/`
...
|---|---|---|
| Lampiran 5 Borang Matriks [JPK/ADI/02-2024] | `2. …/1. Borang Matriks … (IT-072).xlsx` | 11 Proses Kerja (P1–P11) × 26 WA, tanda `/`; semua 6 sheet & formula templat dikekalkan |
...
|---|---|---|
| 4.2 Penjajaran Jam CA/CU | `2. …/4.2_Penjajaran Jam … (IT-072).xlsx` | 18 bulan = 2880 j; teori 20 % = 576 j; CA 80 j; C01–C05 99.2 j setiap satu (12/12/13/12/13 hari = 62 hari); formula templat dikekalkan |
| 4.3 Jadual Teori & Jadual Kerja | `2. …/4.3_Jadual … (IT-072).xlsx` | **Teori:** CA minggu 1–10 → C01 11–22 → C02 23–34 → C03 35–47 → C04 48–59 → C05 60–72. **Kerja:** P01–P11 ikut `03-jadual-latihan.md` §C |
...
| Minggu | Blok | Muat turun (folder `4. …/3.3b Nota Pembelajaran*/`) | Bil |
|---|---|---|---|
| 1–10 | Core Abilities L1+L2+L3 (Z-009-1/2/3:2015) | `3.3b Nota Pembelajaran Core Abilities/3.3b-CA-01 … -47` | 47 |
| 11–22 | C01 Visual Editing Project Analysis | `3.3b Nota Pembelajaran/3.3b-01 … -05` | 5 |
...
Rangka (3.3a) dalaman: `04-rangka-nota-pembelajaran/`. Sumber teks: `05-nota-pembelajaran/`, `11-core-abilities/`.

## Langkah 4 — Soalan setiap blok (Topik 7/8): JSU → Soalan → rekod markah

| Output | Fail | Nota |
|---|---|---|
| 3.2 JSU (Jadual Spesifikasi Ujian) | `4. …/3.2 Format Soalan PENILAIAN PENGETAHUAN (IT-072).xlsx` — sheet `JSU C01`…`JSU C05` + `Prompt Cxx` | 20 soalan/CU, 10:6:4 (R/S/T) & 10:6:4 (P/F/S); formula JUMLAH templat dikekalkan |
| 3.4b Soalan Penilaian Pengetahuan | `4. …/3.4b Penilaian Pengetahuan/3.4b-01 … -05` (C01–C05) dan `3.4b Penilaian Pengetahuan Core Abilities/3.4b-CA-01 … -14` | kertas calon + SKEMA JAWAPAN di muka akhir; lulus 60 % |
| 3.1 Bukti Rekod Penilaian Pengetahuan (markah) | `4. …/3.1_Bukti Penilaian Pengetahuan (IT-072).docx` | 5 CU + 14 CA baris |
...
| Output | Fail | Nota |
|---|---|---|
| 4 Senarai Bukti Proses Kerja | `4. …/4 Senarai Bukti Proses Kerja (IT-072).xlsx` | 34 bukti untuk P01–P11, dipetakan ke CU-WA; sheet GARIS PANDUAN pegawai dikekalkan |
| Lampiran 4 Perakuan Pembimbing [JPK/ADI/01-2024] | `4. …/2_Borang Perakuan Pembimbing … (IT-072).docx` | grid P01–P11 |
...
| Output | Fail |
|---|---|
| Lampiran 6 Laporan Penilaian Bukti Kekompetenan [JPK/ADI/03-2024] | `4. …/1.1 Borang Laporan … (IT-072).docx` (26 + 26 baris pra-isi) |
| Fail Pelaksanaan ADI (syarikat): Isi Kandungan, Surat Tawaran, Surat Lantikan | `2. …/0_Isi Kandungan…`, `3.1a_…`, `5_…` |
| Fail Kompilasi (Bakat): Muka Hadapan, Isi Kandungan (pptx), Separator P01–P11 | `3. …/1_…`, `2_…`, `3_…` |
...
Status semua fail & `[TBD]`: `12-fail-pegawai/INDEX-fail-pegawai.md`.
