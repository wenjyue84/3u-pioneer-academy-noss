...
| 05 | 3.3b | `CU C01-C05/3.3b-01 … -26` (26, templat 3.3b; setiap Bab = Objektif Pembelajaran → sub-topik → Rumusan) · `Core Abilities L1-L3 (format JPK)/KP-CA-01 … -47` (47 docx + 47 PDF, format Kertas Penerangan rasmi JPK dari zip: logo, alamat, jadual pengenalan 6 baris, header NO. KOD/Mukasurat) · `Core Abilities L1-L3/` (47, versi awal gaya 3.3b, simpanan) | `3.3b Template` / PDF rasmi zip | `05-nota-…/`, `11-core-abilities/` |
...
| 13 | **Buku Teks** | `Buku Teks IT-072-3-2012 … C01-C05 (IT-072).docx/.pdf` (164 muka, kulit + TOC berhalaman + 26 Nota) · 5 jilid per CU · `Buku Teks Core Abilities … L1-L3 (IT-072).docx/.pdf` (347 muka, 47 Nota) | kompilasi 3.3b (docxcompose + Word) | 05 |
