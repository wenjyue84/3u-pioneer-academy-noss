...
> **交给政府官员的是 `output/`**（Jay 2026-09-18）：官员模板夹（Drive `1lzKA3Bg…`）的 .xlsx/.docx/.pptx 原样填写，子文件夹和文件名与官员一致；**只含 5 个核心 CU（C01–C05），不含选修 E01**。清单：`output/INDEX-fail-pegawai.md`。下面的 00–11 `.md` 是内部记录/来源，不是交付物。
